...
import { Grid, Table, TableHead, TableBody, TableRow, TableCell, IconButton, Icon, Input } from '@material-ui/core';
...
class TransactionList extends React.Component {
  ...
  addTransaction = () => {
    ...
    if (transactions.filter((t) => {
      ...
      transactions.push(createTranx(this.state.id, this.state.from, this.state.to));
      this.setState({
        data: transactions
      });
    }
